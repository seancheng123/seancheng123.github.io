		...
		<section className="home-content" ref={scrollRef}>
				...
				<RevealSection delay={4.5} direction="up">
					<div className="f-key">
						<DecorativeKey delay={0}>
							<svg className="key-border" viewBox="0 0 20 60" xmlns="http://www.w3.org/2000/svg" overflow="visible">
								<defs>
			...
			<div className="keys">
				<RevealSection delay={1} direction="up">
					<div className="c-key">
						<a className="white-key-animations" href="/repertoire">
							...
							<svg className="key-border" viewBox="0 0 20 60" xmlns="http://www.w3.org/2000/svg" overflow="visible">
								<defs>
									...
									<linearGradient id="whiteKeyGradient" x1="0" y1="0" x2="0" y2="1">
				...
				<RevealSection delay={0} direction="up">
					<div className="d-key">
						<a className="white-key-animations" href="/notes">
				...
				<RevealSection delay={1} direction="up">
					<div className="e-key">
						<a className="white-key-animations" href="/postlude">
							<p>a postlude</p>
				...
				<RevealSection delay={0.5} direction="down">
					<div className="c-sharp">
						<a className="black-key-container black-key-animations" href="/reveries">
				...
				<RevealSection delay={0.5} direction="down">
					<div className="e-flat">
						<a className="black-key-container black-key-animations" href="/letters">
